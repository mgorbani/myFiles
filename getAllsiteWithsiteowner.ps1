...
# #"URL `t Site/List `t Title `t PermissionType `t Permissions `t Login" | out-file UserAccessReport.csv
# $webServ = "http://w2k8-wss3sp2/sites/arbetsytor//_vti_bin/UserGroup.asmx"
# $Service = New-WebServiceProxy -UseDefaultCredential -uri $webServ
# $Users = $Service.GetUserCollectionFromSite().Users

# write-host "Count" $Users.User.count
...
# 	$spUser = $_.LoginName
#   #$_.LoginName.Split('\')[0]"\"$_.LoginName.Split('\')[1]
#   ##write-host "Users: " $spUser
# 	$UserNames.Add($spUser)
# }

# foreach($u in $UserNames ){
# Write-Host "User: " $u
# 	#GetUserAccessReport "http://w2k8-wss3sp2" $u.Split('|')[1]
# }
...
# $webServ = "http://w2k8-wss3sp2:20754/1/_vti_bin/UserGroup.asmx"
# $Service = New-WebServiceProxy -UseDefaultCredential -uri $webServ
